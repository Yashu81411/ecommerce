                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8 col-md-6 col-12">
                                                <div class="list-content">
                                                    ...
                                                    <a href="javascript:void(0)" class="btn buy-now"
...
@push('scripts')
    ...
    {{-- <script>
        $('.cart').click(function(){
            ...
            if(!size){
                swal('Error', 'Please select a size first', 'error');
                return;
            }
            $.ajax({
    ...
    <script>
        $(document).ready(function() {
            $('.buy-now').click(function(e) {
                ...
                // let quant = $('input[name="quant\\[1\\]"]').val();
                ...
                let url = "{{ route('add-to-cart', ':slug') }}".replace(':slug', slug);
                url += `?size=${size}&quant=${quant}`;
